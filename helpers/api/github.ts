 ...
 */
export const convertRepoURLToOwnerAndRepo = (
  repoUrl: string
): [string, string] => {
  ...
  if (
    repoUrlBreakdown[0] === "https:" && // Nowadays this should be a https website
    repoUrlBreakdown[1] === "" && // Should be nothing. https:/{ this is why its empty}/
    (repoUrlBreakdown[2] === "github.com" ||
      repoUrlBreakdown[2] === "www.github.com") && // Either with(out) the www. sub-domain
    repoUrlBreakdown[3] &&
    repoUrlBreakdown[4] && // There needs to be values in the last two
